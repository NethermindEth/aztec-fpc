#!/usr/bin/env bash
# Compile contracts, deploy, and profile BackedCreditFPC gate count.
#
...
# ── Step 2: Deploy + profile BackedCreditFPC ──────────────────────────────────
echo ""
echo "[profile] Running BackedCreditFPC gate count profiler..."
