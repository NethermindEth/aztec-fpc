...
|----------|---------|:-----------:|---------------|
| [**FPCMultiAsset**](/contracts/fpc-multi-asset) | Core fee payment | Yes | `fee_entrypoint`, `cold_start_entrypoint` |
| [**TokenBridge**](/contracts/token-bridge) | L1↔L2 token bridge | Yes | `claim_public`, `claim_private`, `exit_to_l1_public` |
| [**Faucet**](/contracts/faucet) | Test token dispenser | Devnet only | `drip`, `admin_drip` |
