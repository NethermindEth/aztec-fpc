...
:::info[Who runs their own FPC today]
Wallets like [Azguard](https://azguardwallet.io/) and [Obsidion](https://app.obsidion.xyz/) run their own FPC on Aztec testnet — they are simultaneously the operator and the integrator. If you're a wallet team, this guide and [Integrate in a Wallet](/how-to/integrate-wallet) together cover your full deployment. Aztec Alpha Mainnet launched in January 2026 — this is early-mover territory, and production key hygiene matters more than on a mature network.
:::
