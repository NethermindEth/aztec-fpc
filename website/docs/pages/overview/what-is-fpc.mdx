...
```
User                     Attestation Service            Aztec L2
 │                               │                          │
 │── GET /quote ────────────────►│                          │
 │◄── signed quote ──────────────│                          │
 │                               │                          │
 │── submit tx ─────────────────────────────────────────────►│
 │   fee_entrypoint(accepted_asset, authwit_nonce,           │
 │                  fj_fee_amount, aa_payment_amount,        │
 │                  valid_until, quote_sig)                  │
 │   + transfer authwit (execution payload)                  │
 │                                              verify quote │
 │                                       transfer user token │
 │                                         pay Fee Juice    │
 │◄──────────────────────────────────────────────────────────│
