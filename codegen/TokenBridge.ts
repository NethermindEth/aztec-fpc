...
import TokenBridgeContractArtifactJson from './artifacts/token_bridge_contract-TokenBridge.json' with { type: 'json' };
...
export class TokenBridgeContract extends ContractBase {
  ...
  public declare methods: {
    ...
    /** set_config(token: struct, portal: struct) */
    set_config: ((token: AztecAddressLike, portal: EthAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
