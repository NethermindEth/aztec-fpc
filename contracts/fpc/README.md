...
6. For fee-paying txs (any non-zero `maxFeesPerGas` lane), rejects revertible-phase execution; marks contract as fee payer (`set_as_fee_payer`) and unconditionally ends setup.
