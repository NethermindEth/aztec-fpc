...
import { privateKeyToAccount } from "@aztec/viem/accounts";
import * as viemChains from "@aztec/viem/chains";
...
async function deployTestTokenEcosystem(opts: {
  ...
  const l1WalletClient = createWalletClient({
    account: l1Account,
    chain: resolveL1Chain(opts.l1ChainId, opts.l1RpcUrl),
    transport: fallback([http(opts.l1RpcUrl)]),
